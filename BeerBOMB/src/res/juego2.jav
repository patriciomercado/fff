...
public class juego extends javax.swing.JFrame implements ActionListener {
       ...
       int lock = 0;
       int repetido=0;
       int n = 44;  //cantidad de frases para el juego
       int aux = n; //auxiliar
       int cont = 0;
       int pregunta = 0; // posicion de la pregunta
       int over = 0; //cantidad de preguntas eliminadas
            ...
            if (lock == 1){
                ...
                switch (resultado[pregunta]) {
                    ...
                    case 30: jLabel1.setText("Pregunta 30"); 
                        break;
                    case 31:  jLabel1.setText("TPregunta 31"); 
                        break;
